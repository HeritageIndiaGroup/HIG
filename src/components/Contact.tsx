...
"Vinayak Plaza Office",
"Maldahiya, Chetganj, Varanasi", 
"Uttar Pradesh - 221002, India",
  ...
  const regionalOffices = [
    ...
    {
          title: "C/o. Saroj Gupta",
    address: " Chandpur Industrial Estate Chandpur, Varanasi, Uttar Pradesh 221106, India",
    },
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        ...
        <header className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-gray-700">
            {t("Get in touch with Heritage India Group. We're here to answer your questions and explore how we can work together.")}
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Merged Contact Info */}
          <div>
            <h3 className="text-2xl font-bold text-black mb-8">{t('Get In Touch')}</h3>
          ...
          <div>
            <h3 className="text-2xl font-bold text-black mb-8">{t('Our Location')}</h3>
            ...
            <h4 className="text-2xl font-bold text-black mb-6">{t('Regional Offices')}</h4>
