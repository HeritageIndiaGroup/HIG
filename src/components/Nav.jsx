      ...
      <div className="w-full">
        <div className="container mx-auto px-6 py-3 flex items-center">
          <div className="hidden md:flex items-center ml-auto space-x-6 text-base font-bold tracking-wide text-neutral-100">
            ...
            <a href="#contact">
              <Button className="ml-4 bg-white text-black hover:bg-gray-100 font-bold text-sm">
                Get in Touch
              </Button>
            </a>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden px-6 pb-4">
            <nav className="flex flex-col space-y-4 border-t pt-4 text-white text-base">
              ...
              <a href="#contact">
                <Button className="mt-4 bg-white text-black hover:bg-gray-100 font-bold">
                  Get in Touch
                </Button>
              </a>
            </nav>
